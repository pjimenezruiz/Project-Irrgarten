...
class TestP2
    def main
        ...
        unicorn = Irrgarten::Monster.new("Unicornio", Irrgarten::Dice.random_intelligence, Irrgarten::Dice.random_strength)
        dragon = Irrgarten::Monster.new("Dragon", Irrgarten::Dice.random_intelligence, Irrgarten::Dice.random_strength)
        minotaur = Irrgarten::Monster.new("Minotauro", Irrgarten::Dice.random_intelligence, Irrgarten::Dice.random_strength)
        player1 = Irrgarten::Player.new('1', Irrgarten::Dice.random_intelligence, Irrgarten::Dice.random_strength)
        player2 = Irrgarten::Player.new('2', Irrgarten::Dice.random_intelligence, Irrgarten::Dice.random_strength)
        player3 = Irrgarten::Player.new('3', Irrgarten::Dice.random_intelligence, Irrgarten::Dice.random_strength)
        ...
        estado = game.get_gamestate()
        puts estado.get_players
        puts "---------------------------------"
        puts estado.get_monsters
        puts "---------------------------------"
        puts estado.get_labyrinth
        puts "---------------------------------"
        puts estado.get_current_player.to_s
        
        puts "-----------------Funciones de Game ----------------"
        puts "Finished"
        puts game.finished()
        puts "Next step"
        game.next_step(Irrgarten::Directions::RIGHT)
        estado = game.get_gamestate()
        puts estado.get_labyrinth
        puts estado.get_log
        puts "Next step"
        game.next_step(Irrgarten::Directions::UP)
        estado = game.get_gamestate()
        puts estado.get_labyrinth
        puts estado.get_log
        puts "Next step"
        game.next_step(Irrgarten::Directions::DOWN)
        estado = game.get_gamestate()
        puts estado.get_labyrinth
        puts estado.get_log
        puts "Next step"
        game.next_step(Irrgarten::Directions::LEFT)
        estado = game.get_gamestate()
        puts estado.get_labyrinth
        puts estado.get_log
